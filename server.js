...
import Veiculo from './models/Veiculo.js';// Certifique-se de que você rodou 'npm install express dotenv axios cors' no terminal na pasta do projeto
...
// Importa o módulo CORS para permitir requisições do frontend
